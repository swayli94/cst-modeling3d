...
def airfoil3d():
    ...
    wing.output_tecplot(fname=file_dump+'airfoil3d.dat', split=True)
    wing.output_plot3d(fname=file_dump+'airfoil3d.grd', split=True)
...
def transonic_wing():
    ...
    wing = Surface(n_sec=3, name='transonic-wing', nn=101, ns=52)
    ...
    wing.read_setting('./files/swept-wing.txt', tail=0.1)
